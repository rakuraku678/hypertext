...
function startBooking() {
    ...
    #{if token==null || token ==''}
	    ...
	    var promoSlug = "${promotionDto.slug}";
	    var agencySlug = "${promotionDto.agency.slug}";
	    var selectedCurrency = "${selectedCurrency}";
	    $('<iframe src="/auth/'+transactionId+'/'+promoSlug+'/'+selectedCurrency+'/'+agencyId+'/'+agencySlug+'" frameborder="0" style="padding-left: 50px; position: relative; top: -100px;" width="500" height="500" scrolling="no" id="myFrame"></iframe>').appendTo('#loginModalBody');
